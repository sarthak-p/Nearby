...
//            //            print(location)
//            //            print(placemark.subLocality ?? "No street name available")
//            //            self.postal = placemark.subLocality
//            print("Location identified as: \(self.currentLocationDescription ?? "Unknown")")
//            Task {
//                await self.loadContent()
//            }
